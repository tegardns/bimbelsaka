  ...
  const faqs = [
    {
      ...
      answer: 'Kamu bisa mendaftar melalui tombol "Daftar Sekarang" yang ada di website kami atau langsung menghubungi kami via WhatsApp. Tim kami akan membantu proses pendaftaran dan konsultasi program yang sesuai.'
    },
    {
      question: 'Apakah biaya transport tutor sudah termasuk dalam harga?',
      answer: 'Ya, semua biaya transport tutor sudah termasuk dalam harga yang tertera. Kamu tidak perlu membayar biaya tambahan apapun.'
    },
    {
      question: 'Berapa minimal pertemuan dalam seminggu?',
      answer: 'Minimal 2 kali pertemuan dalam seminggu. Namun, jadwal dapat disesuaikan dengan kebutuhan dan kesepakatan bersama tutor.'
    },
    {
      question: 'Apakah tersedia les online?',
      answer: 'Ya, kami menyediakan metode les online via Zoom atau Google Meet. Metode pembelajaran tetap interaktif dan efektif seperti les tatap muka.'
    },
    {
      question: 'Bagaimana sistem pembayaran di Bimbel Saka?',
      answer: 'Pembayaran dilakukan per bulan dengan sistem transfer atau tunai. Detail pembayaran akan dijelaskan saat proses pendaftaran.'
    },
    {
      question: 'Apakah bisa request tutor tertentu?',
      answer: 'Tentu! Kamu bisa merequest tutor berdasarkan preferensi seperti gender, pengalaman, atau spesialisasi mata pelajaran tertentu.'
    }
  ];
    ...
    <section className="py-20 md:py-28 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 text-center p-8 bg-gradient-to-br from-primary/5 to-accent/5 rounded-xl border border-primary/20">
          <h3 className="font-semibold text-foreground mb-2">Masih ada pertanyaan?</h3>
